...
if modo == "📄 Cargar documentos":
    ...
    if st.button("🔍 Mostrar carpetas base disponibles en Drive"):
        st.subheader("📁 Carpetas encontradas en carpeta base:")
        carpetas_base, _ = listar_subcarpetas_y_archivos(DRIVE_FOLDER_ID)
    ...
    if id_ssr:
        ...
        if st.button("📂 Abrir carpeta local"):
            try:
                abrir_carpeta_local(id_sub2)
